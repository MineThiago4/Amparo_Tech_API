    ...
    public class AdminAuthController : ControllerBase
    {
        ...
        private string GerarToken(Administrador admin)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim("idUsuario", admin.IdAdministrador.ToString()), // compatibility for GetUserId
                new Claim("idusuario", admin.IdAdministrador.ToString()),
                new Claim(ClaimTypes.NameIdentifier, admin.IdAdministrador.ToString()), // ensure principal has NameIdentifier
